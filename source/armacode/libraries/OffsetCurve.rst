...
:param object_id = Identifier of a curve object. Can be a curve object:
:type object_id = Identifier of a curve object. Can be a curve object: compatible with Grasshopper
:param plane = Plane to offset on:
:param distance = Distance of the offset:
:param cornerStyle[opt] = the corner style: 0 = None, 1 = Sharp, 2 = Round, 3 = Smooth, 4 = Chamfer
:param capStyle[opt] = capping style: 0 = None, 1 = Flat, 2 = Round
